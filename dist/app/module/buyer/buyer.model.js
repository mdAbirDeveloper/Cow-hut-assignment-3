...
const BuyerSchema = new mongoose_1.Schema({
    ...
    role: {
        type: String,
        enum: buyer_constant_1.buyerRole,
        required: true,
    },
    name: {
        firstName: {
...
BuyerSchema.pre("save", function (next) {
    return __awaiter(this, void 0, void 0, function* () {
        const isExist = yield exports.Buyer.findOne({
            // name: this.name,
            role: this.role,
        ...
        if (isExist) {
            throw new ApiError_1.default(http_status_1.default.CONFLICT, "this buyer is already exist !");
        }
        next();
    });
});
