...
const paginationHelperes_1 = require("../../../helpers/paginationHelperes");
const cow_constant_1 = require("./cow.constant");
const createCow = (payload) => __awaiter(void 0, void 0, void 0, function* () {
    const newBuyer = yield cow_model_1.Cow.create(payload);
    return newBuyer;
});
const GetAllCow = (filters, paginationOptions) => __awaiter(void 0, void 0, void 0, function* () {
    const { searchTerm } = filters, filtersData = __rest(filters, ["searchTerm"]);
    const { page, limit, skip, sortBy, sortOrder } = paginationHelperes_1.paginationHelpers.calculatePagination(paginationOptions);
    const andConditions = [];
    if (searchTerm) {
        andConditions.push({
